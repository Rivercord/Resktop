...
export const enum IpcEvents {
    GET_RIVERCORD_PRELOAD_FILE = "VCD_GET_VC_PRELOAD_FILE",
    GET_RIVERCORD_RENDERER_SCRIPT = "VCD_GET_VC_RENDERER_SCRIPT",
    ...
    SELECT_RIVERCORD_DIR = "VCD_SELECT_RIVERCORD_DIR",
